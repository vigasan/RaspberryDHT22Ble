...
QT_MOC_LITERAL(1, 7, 10), // "sensorData"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4), // "temp"
QT_MOC_LITERAL(4, 24, 3), // "hum"
QT_MOC_LITERAL(5, 28, 17), // "connectionChanged"
QT_MOC_LITERAL(6, 46, 5), // "value"
QT_MOC_LITERAL(7, 52, 12), // "dataReceived"
QT_MOC_LITERAL(8, 65, 12), // "receivedData"
QT_MOC_LITERAL(9, 78, 15), // "deviceConnected"
QT_MOC_LITERAL(10, 94, 18) // "deviceDisconnected"

    },
    "Bridge\0sensorData\0\0temp\0hum\0"
    "connectionChanged\0value\0dataReceived\0"
    "receivedData\0deviceConnected\0"
    "deviceDisconnected"
};
...
void Bridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sensorData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->connectionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Bridge::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bridge::sensorData)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bridge::connectionChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Bridge::sensorData(int _t1, int _t2)
{
...
// SIGNAL 1
void Bridge::connectionChanged(int _t1)
{
